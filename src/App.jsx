    ...
    <div className="bg-gray-50 rounded-3xl p-10 shadow-lg relative overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="font-semibold">buildscouts@gmail.com</p>
          </div>
          <div>
            <p className="text-gray-600 mb-1">Social Media</p>
            <div className="flex gap-4">
              <a href="#" className="hover:opacity-80">
                <img src='/Vector (2).svg' height={24} width={24} />
              </a>
              <a href="#" className="hover:opacity-80">
                <img src='/Group 23.svg' height={24} width={24} />
              </a>
              <a href="#" className="hover:opacity-80">
                <img src='/Vector (3).svg' height={24} width={24} />
              </a>
            </div>
          </div>
        </div>
      ...
      <footer className="py-8 px-6 border-t">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <p className="text-gray-600">© BuildScouts 2024. All rights reserved</p>
